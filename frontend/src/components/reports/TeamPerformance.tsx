  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Team Performance Leaderboard</h3>
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {teamProductivity.map((member, index) => (
                <tr key={index} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      <span className="text-sm font-medium text-gray-900">{member.satisfaction}</span>
        ...
        <div className="h-80">
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={performanceTrend} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
              ...
              <Tooltip />
              <Legend />
              <Bar yAxisId="left" dataKey="completed" fill="#1890ff" name="Projects Completed" />
              <Line 
                yAxisId="right"
                type="monotone" 
                dataKey="efficiency" 
        ...
        <div className="h-80">
          <ResponsiveContainer width="100%" height="100%">
            <RadarChart data={skillsData}>
              ...
              <Radar name="Team Average" dataKey="A" stroke="#1890ff" fill="#1890ff" fillOpacity={0.6} />
              <Radar name="Top Performer" dataKey="B" stroke="#52c41a" fill="#52c41a" fillOpacity={0.6} />
              <Legend />
              <Tooltip />
            </RadarChart>
          </ResponsiveContainer>
